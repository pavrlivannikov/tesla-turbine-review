...
| Стоимость DIY Kit | **~70 700 ₽** |
| Инструменты + место | **14 000–44 000 ₽** |
| **Полная стоимость (свой гараж)** | **~85 000 ₽** |
| **Полная стоимость (с арендой)** | **~115 000 ₽** |
| Окупаемость (свой гараж) | **~5 лет** |
| Годовая экономия | ~18 000 ₽/год |
...
**Все цены в рублях (2026, с учётом инфляции). Курс: ~90 ₽/$**

| № | Позиция | Кол-во | Цена, ₽ |
|---|---|---|---|
| **1. Турбина** | | | |
| 1.1 | Диски алюминиевые (лазерная резка Al 350 мм) | 20 шт | 10 000 |
| 1.2 | Вал + подшипники керамические | 1 компл. | 6 000 |
| 1.3 | Корпус алюминиевый (410×410×106 мм, токарка) | 1 | 7 500 |
| | *Итого турбина* | | **23 500** |
| **2. Генератор** | | | |
| 2.1 | Магниты N52 (кольцевые, для установки между пакетами) | 2+ | 5 000 |
| 2.2 | GaIn сплав (жидкометаллический токосъём, 20 г) | 20 г | 3 500 |
| | *Итого генератор* | | **8 500** |
| **3. Теплообмен** | | | |
| 3.1 | Пластинчатый теплообменник 12 кВт | 1 | 7 500 |
| 3.2 | Конденсатор (автомобильный радиатор + вентилятор) | 1 компл. | 3 500 |
| 3.3 | Насос мембранный R-245fa | 1 | 8 500 |
| 3.4 | R-245fa (2 кг) | 2 кг | 5 000 |
| | *Итого теплообмен* | | **24 500** |
| **4. Электрика (стандартная автомобильная)** | | | |
| 4.1 | АКБ автомобильный 12В 60 А·ч | 1 | 3 500 |
| 4.2 | Инвертор 12→220В, 1000 Вт, чистый синус | 1 | 4 500 |
| 4.3 | Контроллер заряда (авто реле-регулятор) | 1 | 1 200 |
| | *Итого электрика* | | **9 200** |
| **5. Гидравлика** | | | |
| 5.1 | Трубки медные, фитинги, клапаны | 1 компл. | 5 000 |
| | *Итого гидравлика* | | **5 000** |
| | | | |
| | **ИТОГО DIY Kit** | | **~70 700 ₽** |
| | **ИТОГО в USD** | | **~$785** |

### 5.1 Инструменты и рабочее место

Сборка и испытания требуют минимальной мастерской. Если уже есть гараж/мастерская — затраты нулевые.

| № | Позиция | Цена, ₽ | Примечание |
|---|---:|---|
| 6.1 | Верстак + тиски | 8 000 | ИЛИ свой гараж — 0 ₽ |
| 6.2 | Дрель + свёрла | 5 000 | |
| 6.3 | Напильники, ключи, отвёртки | 3 000 | |
| 6.4 | Паяльник + расходники | 2 000 | |
| 6.5 | Манометры, термопары, тахометр | 4 000 | Для испытаний |
| 6.6 | ТЭН 500 Вт + регулятор | 2 000 | Имитация котла |
| 6.7 | Аренда мастерской (1 мес) | 20 000 | ИЛИ гараж/дача — 0 ₽ |
| | **Итого инструменты и место** | **44 000 ₽** | |
| | *При наличии гаража* | **14 000 ₽** | Без аренды |

### 5.2 Полная стоимость запуска

| Сценарий | Сумма |
|---|---|
| DIY Kit (компоненты) | 70 700 ₽ |
| Инструменты + рабочее место | 14 000–44 000 ₽ |
| **ИТОГО (свой гараж)** | **~85 000 ₽** |
| **ИТОГО (аренда мастерской)** | **~115 000 ₽** |
| **Цель крауд-кампании (с гаражом + запас 20%)** | **~100 000 ₽** |
| **Цель крауд-кампании (с арендой + запас 20%)** | **~140 000 ₽** |
...
|---|---|---|---|---|
| **Цена** | **$785** (DIY) | $1 199 | $1 500–2 000 | $500–2 000 |
...
| Экономия в год | **~18 000 ₽/год** |
| Стоимость (DIY + гараж) | 85 000 ₽ |
| **Окупаемость** | **~5 лет** |
...
- **Экономия ~18 000 ₽/год**
- **Окупаемость: 5 лет** (со своим гаражом / дачей)
...
| Стандартный DIY | 70 700 | Полный DIY Kit |
